...
export function expand_targets(targets) {
    const ret = wasm.expand_targets(targets);
    return ret;
}
 ...
 * @returns {any}
 */
export function make_model(inputs, targets) {
    const ret = wasm.make_model(inputs, targets);
    return ret;
}
...
export function make_step(inputs, targets) {
    const ret = wasm.make_step(inputs, targets);
    return ret;
}
 ...
 * @param {any} level
 */
export function update_log_level(level) {
    wasm.update_log_level(level);
}
 ...
 * @returns {any}
 */
export function xyrr_unit(xyrr) {
    const ret = wasm.xyrr_unit(xyrr);
    return ret;
}
...
function __wbg_get_imports() {
    const import0 = {
        ...
        __wbg_error_8e1c3a01560c18a5: function(arg0, arg1) {
            console.error(getStringFromWasm0(arg0, arg1));
        },
        ...
        __wbg_log_dd44bcf7d1fa3765: function(arg0, arg1) {
        ...
        __wbg_warn_1672cd8f0cd48621: function(arg0, arg1) {
