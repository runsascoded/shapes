...
mod tests {
    ...
    fn simple() {
        ...
        let linux = vec![
            (( 1.113, 0.775 ), 9.994e-13, ( 0.264, -1.586 )),  // Step 44
            (( 1.113, 0.775 ), 6.303e-13, ( 0.440,  1.046 )),  // Step 45
            (( 1.113, 0.775 ), 2.499e-13, ( 0.264, -1.586 )),  // Step 46
            (( 1.113, 0.775 ), 1.550e-13, ( 0.440,  1.046 )),  // Step 47
            (( 1.113, 0.775 ), 5.876e-14, ( 0.264, -1.586 )),  // Step 48
            (( 1.113, 0.775 ), 3.547e-14, (-0.264,  1.586 )),  // Step 49
            (( 1.113, 0.775 ), 2.279e-14, ( 0.704, -0.540 )),  // Step 50
            (( 1.113, 0.775 ), 8.160e-15, ( 0.440,  1.046 )),  // Step 51
            (( 1.113, 0.775 ), 5.745e-15, ( 0.264, -1.586 )),  // Step 52
            (( 1.113, 0.775 ), 4.441e-15, ( 0.440,  1.046 )),  // Step 53
            (( 1.113, 0.775 ), 2.554e-15, ( 0.264, -1.586 )),  // Step 54
            (( 1.113, 0.775 ), 1.832e-15, ( 0.440,  1.046 )),  // Step 55
            (( 1.113, 0.775 ), 9.714e-16, ( 0.264, -1.586 )),  // Step 56
            (( 1.113, 0.775 ), 8.604e-16, (-0.264,  1.586 )),  // Step 57
            (( 1.113, 0.775 ), 7.494e-16, ( 0.264, -1.586 )),  // Step 58
            (( 1.113, 0.775 ), 6.384e-16, (-0.264,  1.586 )),  // Step 59
            (( 1.113, 0.775 ), 5.551e-16, ( 0.264, -1.586 )),  // Step 60
            (( 1.113, 0.775 ), 3.608e-16, ( 0.440,  1.046 )),  // Step 61
            (( 1.113, 0.775 ), 2.220e-16, (-0.704,  0.540 )),  // Step 62
            (( 1.113, 0.775 ), 4.996e-16, ( 0.264, -1.586 )),  // Step 63
            (( 1.113, 0.775 ), 3.608e-16, ( 0.440,  1.046 )),  // Step 64 == Step 61, break
        ];
