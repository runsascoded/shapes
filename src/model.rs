...
mod tests {
    ...
    fn fizz_buzz_circle_ellipse() {
        ...
        let linux = [both, vec![
            ...
            ([ 1.100, 0.749, 0.801 ], 3.209e-11, [-0.449, -0.433, -0.617 ]),  // Step 32
            ([ 1.100, 0.749, 0.801 ], 9.899e-12, [-0.719,  0.452,  0.083 ]),  // Step 33
            ([ 1.100, 0.749, 0.801 ], 8.860e-12, [-0.449, -0.433, -0.617 ]),  // Step 34
            ([ 1.100, 0.749, 0.801 ], 2.639e-12, [-0.449, -0.433, -0.617 ]),  // Step 35
            ([ 1.100, 0.749, 0.801 ], 2.345e-12, [-0.719,  0.452,  0.083 ]),  // Step 36
            ([ 1.100, 0.749, 0.801 ], 7.464e-13, [-0.719,  0.452,  0.083 ]),  // Step 37
            ([ 1.100, 0.749, 0.801 ], 5.682e-13, [-0.449, -0.433, -0.617 ]),  // Step 38
            ([ 1.100, 0.749, 0.801 ], 1.860e-13, [-0.719,  0.452,  0.083 ]),  // Step 39
            ([ 1.100, 0.749, 0.801 ], 1.556e-13, [-0.449, -0.433, -0.617 ]),  // Step 40
            ([ 1.100, 0.749, 0.801 ], 5.337e-14, [-0.719,  0.452,  0.083 ]),  // Step 41
            ([ 1.100, 0.749, 0.801 ], 4.494e-14, [-0.449, -0.433, -0.617 ]),  // Step 42
            ([ 1.100, 0.749, 0.801 ], 1.601e-14, [-0.719,  0.452,  0.083 ]),  // Step 43
            ([ 1.100, 0.749, 0.801 ], 8.687e-15, [ 0.270, -0.884, -0.700 ]),  // Step 44
            ([ 1.100, 0.749, 0.801 ], 1.182e-14, [-0.719,  0.452,  0.083 ]),  // Step 45
            ([ 1.100, 0.749, 0.801 ], 7.189e-15, [ 0.270, -0.884, -0.700 ]),  // Step 46
            ([ 1.100, 0.749, 0.801 ], 9.021e-15, [-0.719,  0.452,  0.083 ]),  // Step 47
            ([ 1.100, 0.749, 0.801 ], 5.190e-15, [ 0.270, -0.884, -0.700 ]),  // Step 48
            ([ 1.100, 0.749, 0.801 ], 1.055e-15, [ 0.719, -0.452, -0.083 ]),  // Step 49
            ([ 1.100, 0.749, 0.801 ], 7.772e-16, [ 0.449,  0.433,  0.617 ]),  // Step 50
            ([ 1.100, 0.749, 0.801 ], 9.159e-16, [ 0.719, -0.452, -0.083 ]),  // Step 51
            ([ 1.100, 0.749, 0.801 ], 6.106e-16, [ 0.449,  0.433,  0.617 ]),  // Step 52
            ([ 1.100, 0.749, 0.801 ], 4.718e-16, [ 0.719, -0.452, -0.083 ]),  // Step 53
            ([ 1.100, 0.749, 0.801 ], 3.886e-16, [ 0.449,  0.433,  0.617 ]),  // Step 54
            ([ 1.100, 0.749, 0.801 ], 2.776e-16, [ 0.719, -0.452, -0.083 ]),  // Step 55
            ([ 1.100, 0.749, 0.801 ], 8.327e-17, [-0.270,  0.884,  0.700 ]),  // Step 56
            ([ 1.100, 0.749, 0.801 ], 8.327e-17, [-0.270,  0.884,  0.700 ]),  // Step 57
        ].to()].concat();
        let expecteds = if os == "macos" { macos } else { linux };
    ...
    fn fizz_buzz_ellipses_diag() {
        ...
        let expecteds: Vec<ExpectedStep> = vec![
            ...
            // Values become nondeterministic past step 10! TODO: debug.
        ].to();

        check(inputs, FIZZ_BUZZ.into(), expecteds, 0.7, 10)
    }
