...
mod tests {
    ...
    fn simple() {
        ...
        let macos = vec![
            ...
            (( 1.113, 0.775 ), 3.503e-14, ( 0.704, -0.540 )),  // Step 54
            (( 1.113, 0.775 ), 1.102e-14, ( 0.440,  1.046 )),  // Step 55
            (( 1.113, 0.775 ), 1.185e-14, ( 0.704, -0.540 )),  // Step 56
            (( 1.113, 0.775 ), 3.691e-15, ( 0.440,  1.046 )),  // Step 57
            (( 1.113, 0.775 ), 4.274e-15, ( 0.704, -0.540 )),  // Step 58
